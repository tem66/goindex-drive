...
function nav(path) {
    ...
    <a href="https://www.kaokew.com"  class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: '点击返回网站主页'}">
...
function get_file(path, file, callback){
	...
	if(data != undefined){
		...
		$.get(path, function(d){
            ...
            <div>
              <a href="http://www.kaokew.com/link/adleft" target="_blank">
	      <img src="http://pic.kaokew.com/adleft.png"  style="bottom:250px; left:20px; position:absolute; max-width:180px;width:100%" ></a>
            </div> 
            
       
            <div>
              <a href="http://www.kaokew.com/link/adleft" target="_blank">
	      <img src="http://pic.kaokew.com/adright.png"  style="bottom:250px; left:20px; position:absolute; max-width:180px;width:100%"  ></a>
            </div>
...
<pre id="editor" ></pre>
  ...
  <div align="center">
       ...
       <img  src="http://pic.kaokew.com/ad2.png" style="max-width:950px;width:100%" />
            ...
            <div>
              <a href="http://www.kaokew.com/link/adleft" target="_blank">
              <img src="http://pic.kaokew.com/adright.png"  style="style="bottom:250px; left:20px; position:absolute; max-width:180px;width:100%" " ></a>
            </div>
